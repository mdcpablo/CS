...
# -----------------------------------------------------------------------------
dofs = [200,400]
mg_k, mg_k_error = readfiles_dofs('',dofs,'mg.xml',I=250,N=128,L_max=5,note='MG')
oldfeds_k, oldfeds_k_error = readfiles_dofs('',dofs,'oldfeds_5EperCG.xml',I=250,N=128,L_max=5,note='old FEDS (5 elements per coarse group)')
newfeds_k, newfeds_k_error = readfiles_dofs('',dofs,'newfeds.xml',I=250,N=128,L_max=5,note='new FEDS')
# -----------------------------------------------------------------------------
print mg_k
print oldfeds_k
print newfeds_k
