...
mesh = SN.GlobalMesh(mat_dict, [heu_1], 32, 25, 'slab')
mesh.print_energies()
mesh.print_angles()
mesh.print_space(v=0)

k, phi, psi, runtime_mg, mg_iter_dict = SN.power_iterations(mesh, 'k', 'mg', mode='not debug', L_max=8, tol=1e-5, max_its=1000, k_exact=1.11677401)
k, phi, psi, runtime_cs, cs_iter_dict = SN.power_iterations(mesh, 'k', 'cs', mode='not debug', L_max=8, tol=1e-5, max_its=1000, k_exact=1.11677401, recomp_F=8, recomp_S=[2,16,16,32,32,32,32,32])
print runtime_mg
print runtime_cs
