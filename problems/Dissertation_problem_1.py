...
###############################################################################
mat_dict = {'hmf001': newGridXML2newGridObject.dict_to_object('hmf001_500mg.xml', 92001)}
...
k, phi, psi, runtime_mg, mg_iter_dict = SN.power_iterations(mesh, 'k', 'mg', mode='not debug', L_max=1, tol=1e-5, max_its=1000, k_exact=1.1812991)
k, phi, psi, runtime_cs, cs_iter_dict = SN.power_iterations(mesh, 'k', 'cs', mode='not debug', L_max=1, tol=1e-5, max_its=1000, k_exact=1.1812991, recomp_F=8, recomp_S=[2,16,16,32,32,32,32,32])
print runtime_mg
print runtime_cs
