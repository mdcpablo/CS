...
dofs = [10, 25, 50, 100, 250, 500,1000]
...
for G in dofs:
    ...
    k, phi, psi, runtime_cs, iter_dict = SN.power_iterations(mesh, 'k', 'cs', mode='not debug', L_max=1, tol=1e-5, max_its=1000, k_exact=k_exact, recomp_F=12, recomp_S=[3,12,12,12])
