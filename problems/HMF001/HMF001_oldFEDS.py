...
def run(xs_file, I=2, N=2, L_max=1, note=''):
    ...
    k, phi, psi, runtime_mg, iter_dict = SN.power_iterations(mesh, bc, 'k', 'mg', mode='normal', L_max=L_max, tol=1e-8, max_its=60, k_exact=k_exact, DSA_opt=False)
...
dofs = [100,200,400,600,800]
oldfeds_k, oldfeds_k_error = run_dofs('HMF001_',dofs,'oldfeds_5EperCG.xml',I=500,N=128,L_max=5,note='old FEDS (5 elements per coarse group)')
